...
class API_Manager_WRI_Update_API_Check { //TBSET: Change the class names so they are unique to your plugin.
	...
	public function plugin_information( $args ) {
		...
		//wsl_log(null, 'WRI class-wc-plugin-update.php plugin_information $args: ' . wsl_vartotext($args));
		//wsl_log(null, 'WRI class-wc-plugin-update.php plugin_information $target_url: ' . wsl_vartotext($target_url));
		...
		//wsl_log(null, 'WRI class-wc-plugin-update.php plugin_information $response: ' . wsl_vartotext($response));
	...
	public function cancelled_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been canceled. You can renew the subscription from your account <a href="%s" target="_blank">dashboard</a>. A new license key will be emailed to you after your order has been completed.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url ) ;
	...
	public function switched_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'You changed the subscription for %s, so you will need to enter your new License Key in the settings page. The License Key should have arrived in your email inbox, if not you can get it by logging into your account <a href="%s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url ) ;
